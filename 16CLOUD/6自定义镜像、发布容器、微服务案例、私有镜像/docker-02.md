...
微服务：微服务架构是一种架构模式，他提倡将单一应用程序划分成一组小的服务，服务之间相互协调、相互配合、为用户提供最终价值。

微服务架构有别于更为传统的单体式方案，将应用拆分成多个核心功能。可以单独构建和部署

微服务架构不只应用核心功能间的这种松散耦合，它还涉及到如何进行服务间通信以应对不可避免的故障、满足未来的可扩展性并实现新的功能集成。

优点：它解决了复杂性问题可以独立开发、运行，降低了服务耦合性更合适ci/cd

​            高扩展，出色的弹性，易于部署易于访问、更加开发松耦合高内聚



容器间的通信，

host 模式，与宿主机共享网络（容器智联真机）
...
命令：curl http://仓库ip：5000/v2/_catalog 访问仓库
